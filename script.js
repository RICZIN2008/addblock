...
(function() {
    ...
    menu.innerHTML = `
        <h3 style="text-align:center;color:red;margin:0 0 10px 0">TDK MENU v3.1</h3>
    ...
    setInterval(() => {
        document.querySelectorAll('div[class*="banner"], div[class*="overlay"], div[id*="pop"],.adsbygoogle').forEach(el => {
           if(![btn,menu,infoWin].includes(el)) el.remove();
        });
    }, 2000);
    console.clear();
    ...
    style.innerHTML = `a,a:visited{color:red!important} img{max-width:50px!important;max-height:50px!important} video,iframe{max-width:100%!important;visibility:visible!important}`;
